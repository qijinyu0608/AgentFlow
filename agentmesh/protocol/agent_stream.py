...
class AgentStreamExecutor:
        ...
        try:
            ...
            for chunk in stream:
                ...
                if isinstance(chunk, dict) and "choices" in chunk:
                    # Some OpenAI-compatible streaming implementations may emit
                    # chunks with empty choices (e.g. keep-alives). Skip safely.
    ...
    def _execute_tool(self, tool_call: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(self.agent, "capture_tool_use"):
                self.agent.capture_tool_use(
                    tool_name=tool_name,
